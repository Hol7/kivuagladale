...
const Card: React.FC<CardProps> = ({ title, imageUrl }) => {
    return (
        <div className="bg-white rounded-md w-full sm:w-[340px]">
            ...
            <div
                className="relative bg-cover rounded-md bg-center h-72 w-full p-8"
...
const Service: React.FC = () => {
    ...
    return (
        <div className="flex flex-col sm:flex-row gap-10 py-10 bg-white justify-center items-center">
